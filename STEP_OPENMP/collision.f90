...
!$OMP PRIVATE(pxx,pyy,pxy)  &
!$OMP PRIVATE(Txx,Tyy,Txy)  &
!$OMP PRIVATE(feq00,feq01,feq02,feq03,feq04)  &
!$OMP PRIVATE(feq05,feq06,feq07,feq08     )  &
!$OMP PRIVATE(ft0,ft1,ft2,ft3,ft4     )  &
!$OMP PRIVATE(ft5,ft6,ft7,ft8         )  &
!$OMP PRIVATE(geq00,geq01,geq02,geq03,geq04)  &
!$OMP PRIVATE(geq05,geq06,geq07,geq08     )  &
!$OMP PRIVATE(gt0,gt1,gt2,gt3,gt4     )  &
!$OMP PRIVATE(gt5,gt6,gt7,gt8         )  &
!$OMP SHARED(Nx,Ny)   &
!$OMP SHARED(cs2)   &
!$OMP SHARED(u,v,rho,T)   &
